...
const TrustLogUI = require('../components_jsx/TrustLogUI.jsx').default;
const ReplayLogViewer = require('../components_jsx/ReplayLogViewer.jsx').default;
const MerkleChainVisualizer = require('../components_jsx/MerkleChainVisualizer.jsx').default;
const TrustSurfaceDisplay = require('../components_jsx/TrustSurfaceDisplay.jsx').default;
const pre_loop_tether_check = require('../utils/tetherCheck');
...
// Initialize fetch mock implementation for specific URLs
beforeEach(() => {
...
describe('TrustLogUI Component', () => {
  ...
  test('displays all tabs and switches between them', async () => {
    ...
    await user.click(screen.getByText('Merkle Chain'));
