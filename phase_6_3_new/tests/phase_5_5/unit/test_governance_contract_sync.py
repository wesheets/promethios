...
class TestGovernanceContractSync(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.schema_validator = SchemaValidator(schema_dir="/home/ubuntu/promethios_phase_5_5/schemas")
    ...
    @patch('schemas.governance.governance_contract_sync.requests.post')
    ...
    def test_distribute_contract_partial_failure(self, mock_post):
        ...
        def side_effect(*args, **kwargs):
            ...
            url = args[0]
            # Check if the first node_id is in the URL
            if self.target_node_ids[0] in url:
