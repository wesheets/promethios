...
class TestExternalTrigger(unittest.TestCase):
    ...
    @patch('src.main.runtime_executor.pre_loop_tether_check')
    @patch('src.main.runtime_executor.RuntimeExecutor.execute_core_loop')
    ...
    @patch('src.main.runtime_executor.pre_loop_tether_check')
    @patch('src.main.runtime_executor.RuntimeExecutor.handle_external_trigger')
