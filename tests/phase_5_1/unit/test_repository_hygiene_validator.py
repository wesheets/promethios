...
# Import the test schema validator
from tests.utils.test_schema_validator import TestSchemaValidator
...
class TestRepositoryHygieneValidator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.schema_validator = TestSchemaValidator(skip_tether_check=True)
