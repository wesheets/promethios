            ...
            <div className="mb-2 relative h-28 overflow-visible w-full -mt-8 animated-text-fadeout">
              <div className="absolute inset-0 flex items-center">
                <div className="relative w-full">
                  ...
                  {/* Dynamic "is/are on the line." text positioned on the right - right-aligned with dashboard */}
                  <div className="absolute right-0 top-0 text-right">
                    <span className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-bold text-white static-text-is italic">
                      is on the line.
                    </span>
                    <span className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-bold text-white static-text-are italic">
                      are on the line.
                    </span>
                  </div>
