    ...
    <div className={`rounded-lg overflow-hidden ${className} ${
      ...
      <div className="p-4">
        <div className="flex items-center mb-3">
          ...
          <h3 className="text-lg font-semibold">LIVE & UNSCRIPTED</h3>
        </div>
        
        <div className="mb-4">
          <p className="text-sm mb-2">
            <strong>What you're about to see hasn't been pre-written.</strong> These are live, unscripted responses from OpenAI.
          </p>
          <p className="text-sm">
        ...
        <div className={`flex items-center p-2 rounded ${
          ...
          <p className="text-xs">
            <strong>Powered by OpenAI</strong> - Both agents use identical models and settings. The only difference is Promethios governance.
          </p>
        </div>
      </div>
    </div>
