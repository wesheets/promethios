/**
 * UnifiedHeaderTabs - New unified header tabs component that replaces CompactSharedChatTabs
 * Integrates with UnifiedChatPanel and maintains the same workflow as before
 */
...
interface UnifiedHeaderTabsProps {
...
const UnifiedHeaderTabs: React.FC<UnifiedHeaderTabsProps> = ({
  sharedConversations,
...
export default UnifiedHeaderTabs;
