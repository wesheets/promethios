...
// Configuration for the real agent API
const API_BASE_URL = process.env.NODE_ENV === 'production' 
  ? 'https://promethios-phase-7-1-api.onrender.com/api/benchmark' 
  : 'https://promethios-phase-7-1-api.onrender.com/api/benchmark';

// Simulated responses for marketing demo (unchanged)
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      >
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                Governance: {governanceEnabled ? 'ENABLED' : 'DISABLED'} • {isLoggedIn ? 'Live Agent' : 'Demo Mode'}
              </p>
            </div>
          </div>
        ...
        {/* Demo Mode Indicator */}
        {!isLoggedIn && (
          <div className="px-6 py-3 bg-blue-900/20 border-b border-blue-500/30">
            <div className="flex items-center space-x-2">
              <span className="text-blue-400">ℹ️</span>
              <span className="text-blue-300 text-sm">
                This is a marketing demo with simulated responses. 
                <button className="underline ml-1 hover:text-blue-200">Sign up for live agent access</button>
              </span>
            </div>
          </div>
        )}
