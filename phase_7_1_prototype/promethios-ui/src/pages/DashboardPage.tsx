...
const DashboardPage: React.FC = () => {
  ...
  // Real-time metrics for all user agents (deferred until dashboard loads)
  ...
  useEffect(() => {
    ...
    loadUserAgents();
  }, [currentUser, metrics?.agents?.total]); // Re-run when currentUser changes or dashboard loads
