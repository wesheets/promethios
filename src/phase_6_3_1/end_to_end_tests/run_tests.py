"""
Simplified test runner for end-to-end tests

This script runs the end-to-end tests without relying on patches,
using direct imports and utility methods instead.
"""
...
def run_tests():
    ...
    # Import test modules here to ensure paths are set up correctly
