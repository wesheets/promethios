...
UI_ROOT = os.path.dirname(SRC_DIR) # This is the actual REPO_ROOT for promethios_clean_pr
REPO_ROOT = UI_ROOT  # Corrected: REPO_ROOT should be the UI_ROOT which is the project root
...
print(f"Corrected REPO_ROOT: {REPO_ROOT}")
